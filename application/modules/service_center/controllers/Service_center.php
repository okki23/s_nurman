...
class Service_center extends Parent_controller {
  ...
  var $parsing_form_input = array('id','nama_barang','qty','satuan');
  var $tablename = 'm_service_center';

    public function __construct() {
        parent::__construct();
        $this->load->model('m_service_center','m_service_center');
    ...
    public function index() {
        ...
        $data['listing'] = $this->m_service_center->get_all($id=NULL,$this->tablename)->result();
    ...
    public function get_bawahan_foreman($idforeman) {
        ...
        $data['idservice_center'] = $this->session->userdata('idservice_center');
    ...
    public function add() {
        ...
        $data['opt_service_center'] = $this->model_user_management->opt_service_center();
    ...
    public function get_val_peg() {
        ...
        $data = $this->db->get('tb_service_center')->row();
    ...
    public function pro_add() {
        ...
        $datapos = array('nrp' => $this->input->post('nrp'),
            ...
            'id_service_center' => $this->input->post('id_service_center'),
